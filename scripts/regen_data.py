...
# than leaving them generating a file nothing reads. The OLD standalone "Model vs Markets"
# page this fed (pre-dating the embedded tab, linked from nowhere) was moved to
# docs/archive/model.html the same day, once its condition for removal was confirmed met --
# see analysis/model_compare.py's docstring.
